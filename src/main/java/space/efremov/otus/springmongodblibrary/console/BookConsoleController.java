...
//        return bookRepository.save(new Book(title, isbn, year, publisher, tags, authors));
    ...
    public void remove(@ShellOption(help = "Book ID. You can use \"book list\" command to found ID", value = {"book-id", "bid", "bookId", "id"}) String id) {
    ...
    public Book get(@ShellOption(help = "book ID.", value = {"book-id", "bid", "bookId", "id"}) String id) {
